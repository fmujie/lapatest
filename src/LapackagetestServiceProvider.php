...
namespace Fmujie\Lapackagetest;

use Illuminate\Support\ServiceProvider;

class LapackagetestServiceProvider extends ServiceProvider
{
      /**
     * 服务提供者加是否延迟加载.
     *
     ...
     */
     ...
     {
          // 单例绑定服务
         $this->app->singleton('Lapackagetest', function ($app) {
             return new Lapackagetest($app['session'], $app['config']);
         });
     }
     /**
